...
SimpleWebRTC.prototype.joinRoom = function (name, cb) {
    console.error("WARNING !! SimpleWebRTC.prototype.joinRoom SHOULD NOT HAVE BEEN CALLED !!");
    var self = this;
    this.roomName = name;
    this.connection.emit('join', name, function (err, roomDescription) {
        ...
        if (err) {
            ...
            for (id in roomDescription.clients) {
                ...
                console.log('CLIENT from roomdescription : ', client);
...
},{"webrtc-adapter-test":13}],13:[function(require,module,exports){
/*
...
//    console.log('CREATING PEER WITH OPTS ---------->> ', options, this);
...
Peer.prototype.start = function () {
    ...
    if (this.pc.streamsDirections) {
        this.pc.streamsDirections = this.pc.streamsDirections;
        this.receiveMedia = {
            offerToReceiveAudio : this.pc.streamsDirections.audio.receive, 
            offerToReceiveVideo : this.pc.streamsDirections.video.receive
        }
    } else debugger;
...
},{"filetransfer":16,"rtcpeerconnection":15,"util":8,"webrtcsupport":4,"wildemitter":5}],11:[function(require,module,exports){
...
},{"getscreenmedia":20,"getusermedia":21,"hark":19,"mediastream-gain":22,"mockconsole":7,"util":8,"webrtcsupport":18,"wildemitter":5}],23:[function(require,module,exports){
/*
 *  Copyright (c) 2014 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
if (typeof summarizeSDP === 'undefined') summarizeSDP = function(sdp) {
    var splitSDP = sdp.split('\r\n');
    var result = splitSDP.filter(function(value, index, array) {
        return (
            (value.indexOf('m=') > -1) ||
            (value.indexOf('a=sendrecv') > -1) ||
            (value.indexOf('a=sendonly') > -1) ||
            (value.indexOf('a=recvonly') > -1) ||
            (value.indexOf('a=inactive') > -1))
    }).join('\r\n');
    return result;
}
...
PeerConnection.prototype.offer = function (constraints, cb) {
    ...
    this.pc.createOffer(
        function (offer) {
//            console.log('CREATE OFFER before filters (', self._role(), ') :', '\r\n' + summarizeSDP(offer.sdp));
            
            var splitSDP = offer.sdp.split('\r\n');
            var currentSection = null;
            
            // remove unwanted tracks
            for (var i = 0; i < splitSDP.length; i++) {
                if (!currentSection) {
                    if (splitSDP[i].indexOf('m=') === 0) {
                        currentSection =    (splitSDP[i].substr(2, 6) === "audio ") ? "audio" :
                                            (splitSDP[i].substr(2, 6) === "video ") ? "video" : null;
                    }
                } else {
                    var send = null, receive = null;
                    if        (splitSDP[i].startsWith('a=sendrecv')) {
                        send =    self.streamsDirections[currentSection].send && true;
                        receive = self.streamsDirections[currentSection].receive && true;
                    } else if (splitSDP[i].startsWith('a=sendonly')) {
                        send =    self.streamsDirections[currentSection].send && true;
                        receive = self.streamsDirections[currentSection].receive && false;
                    } else if (splitSDP[i].startsWith('a=recvonly')) {
                        send =    self.streamsDirections[currentSection].send && false;
                        receive = self.streamsDirections[currentSection].receive && true;
                    } else if (splitSDP[i].startsWith('a=inactive')) {
                        send =    self.streamsDirections[currentSection].send && false;
                        receive = self.streamsDirections[currentSection].receive && false;
                    }
                    if (send !== null) {
                        currentSection = null;
                        var newDirection = (send && receive) ? 'sendrecv' : send ? 'sendonly' : receive ? 'recvonly': 'inactive';
                        splitSDP[i] = 'a=' + newDirection + splitSDP[i].slice(11);
                    }
                }
            }
//            console.log('BEFORE\n', offer, '\r\n' + summarizeSDP(offer.sdp) );
...
//            var jingle_offer = SJJ.toSessionJSON(offer.sdp, {
//                role: self._role(),
//                direction: 'outgoing'
//            });
            
//            console.log('jingle_offer : ', jingle_offer);
            
       
            
//            offer.sdp = SJJ.toSessionSDP(jingle_offer, {
//                role : self._role(),
//                direction: 'outgoing'
//            });
//            
//            console.error('CREATE OFFER after filters (', self._role(), ') :', summarizeSDP(offer.sdp));
            ...
            if (self.streamsDirections) {
                expandedOffer.streamsDirections = {
                    audio : { receive : self.streamsDirections.audio.send, send : self.streamsDirections.audio.receive },
                    video : { receive : self.streamsDirections.video.send, send : self.streamsDirections.video.receive }
                }
            } else {
                console.error("should have streamsDirections", self);
            }
...
PeerConnection.prototype._answer = function (constraints, cb) {
    ...
    console.log('ANSWER   constraints BEFORE ', constraints);
//    if (self.streamsDirections) constraints = {
//        offerToReceiveAudio: self.streamsDirections.audio.receive,
//        offerToReceiveVideo: self.streamsDirections.video.receive
//    } 
    if (self.streamsDirections) constraints = {
        mandatory : {
            OfferToReceiveAudio: self.streamsDirections.audio.receive,
    ...
    console.log('ANSWER   constraints ', constraints)
        ...
        function (answer) {
            ...
            self.pc.setLocalDescription(answer,
                function () {
                    ...
                    console.log('ANSWER role (setLocalDescription: ', self._role(), ')');
...
},{"lodash.foreach":26,"lodash.pluck":27,"sdp-jingle-json":24,"traceablepeerconnection":25,"util":8,"webrtc-adapter-test":23,"wildemitter":5}],16:[function(require,module,exports){
var WildEmitter = require('wildemitter');
var util = require('util');
...
},{"util":8,"wildemitter":5}],19:[function(require,module,exports){
var WildEmitter = require('wildemitter');
...
},{"wildemitter":28}],21:[function(require,module,exports){
...
},{"./lib/tojson":30,"./lib/tosdp":31}],20:[function(require,module,exports){
...
},{"./manager":33,"./socket":34,"./url":32,"debug":35,"socket.io-parser":36}],35:[function(require,module,exports){
...
},{"lodash._baseget":38,"lodash._topath":39,"lodash.isarray":40,"lodash.map":41}],26:[function(require,module,exports){
/**
...
},{"lodash._arrayeach":42,"lodash._baseeach":45,"lodash._bindcallback":43,"lodash.isarray":44}],30:[function(require,module,exports){
...
},{"./parsers":47,"./senders":46}],31:[function(require,module,exports){
var SENDERS = require('./senders');


exports.toSessionSDP = function (session, opts) {
    var role = opts.role || 'initiator';
//console.log('ROLE in toSessionSDP ---------------------', role);
    var direction = opts.direction || 'outgoing';
...
exports.toMediaSDP = function (content, opts) {
    ...
    var role = opts.role || 'initiator';
//console.log('ROLE in toMediaSDP ---------------------', role);
    var direction = opts.direction || 'outgoing';
...
},{"./senders":46}],38:[function(require,module,exports){
/**
...
},{"util":8,"webrtc-adapter-test":23,"wildemitter":5}],51:[function(require,module,exports){
/**
 * Slice reference.
 */
...
},{"./binary":60,"./is-buffer":57,"component-emitter":49,"debug":35,"isarray":58,"json3":59}],45:[function(require,module,exports){
/**
 * lodash 3.0.4 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"isarray":63}],64:[function(require,module,exports){
/**
 * lodash 3.0.0 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash.isarray":40}],41:[function(require,module,exports){
/**
...
},{"lodash._arraymap":64,"lodash._basecallback":65,"lodash._baseeach":66,"lodash.isarray":40}],63:[function(require,module,exports){
module.exports = Array.isArray || function (arr) {
  return Object.prototype.toString.call(arr) == '[object Array]';
};
...
},{"lodash._baseisequal":73,"lodash._bindcallback":67,"lodash.isarray":40,"lodash.pairs":74}],61:[function(require,module,exports){
/**
 * lodash 3.1.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":68,"lodash.isarguments":69,"lodash.isarray":44}],75:[function(require,module,exports){
var global=self;/**
 * Module dependencies
 */
...
},{"./polling-jsonp":78,"./polling-xhr":77,"./websocket":79,"xmlhttprequest":76}],80:[function(require,module,exports){
...
},{"./transport":85,"./transports":75,"component-emitter":49,"debug":86,"engine.io-parser":72,"indexof":53,"parsejson":83,"parseqs":84,"parseuri":82}],87:[function(require,module,exports){
/**
 * lodash 3.0.4 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash.keys":70}],90:[function(require,module,exports){
...
},{"lodash.isarray":40,"lodash.istypedarray":81,"lodash.keys":70}],70:[function(require,module,exports){
/**
 * lodash 3.1.2 (Custom Build) <https://lodash.com/>
 * Build: `lodash modern modularize exports="npm" -o ./`
 * Copyright 2012-2015 The Dojo Foundation <http://dojofoundation.org/>
...
},{"lodash._getnative":88,"lodash.isarguments":87,"lodash.isarray":40}],85:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"component-emitter":49,"engine.io-parser":72}],91:[function(require,module,exports){
/**
...
},{"./keys":80,"after":93,"arraybuffer.slice":91,"base64-arraybuffer":92,"blob":94,"has-binary":56,"utf8":90}],76:[function(require,module,exports){
...
},{"./polling":97,"component-inherit":98}],79:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"./polling":97,"component-emitter":49,"component-inherit":98,"debug":86,"xmlhttprequest":76}],98:[function(require,module,exports){
...
},{"../transport":85,"component-inherit":98,"debug":86,"engine.io-parser":72,"parseqs":84,"xmlhttprequest":76}]},{},[1])(1)
});
;